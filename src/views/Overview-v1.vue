      ...
      <div class="row">
        <div class="column">
          <div v-for="(image, imageKey) in imageColumn1" :key="imageKey">
            <img
              :id="image._id"
              v-lazy="resizeImage(image.imageUrl, 'h_700,,q_auto')"
              alt=""
              style="width: 100%"
            />
          </div>
        ...
        <div class="column">
          <div v-for="(image2, imageKey2) in imageColumn2" :key="imageKey2">
            <img
              :id="image2._id"
              v-lazy="resizeImage(image2.imageUrl, 'h_700,q_auto')"
              alt=""
              style="width: 100%"
            />
          </div>
        ...
        <div class="column">
          <div v-for="(image3, imageKey3) in imageColumn3" :key="imageKey3">
            <img
              :id="image3._id"
              v-lazy="resizeImage(image3.imageUrl, 'h_700,q_auto')"
              alt=""
              style="width: 100%"
            />
          </div>
        ...
        <div class="column">
          <div v-for="(image4, imageKey4) in imageColumn4" :key="imageKey4">
            <img
              :id="image4._id"
              v-lazy="resizeImage(image4.imageUrl, 'h_700,q_auto')"
              alt=""
              style="width: 100%"
            />
          </div>
...
export default {
  ...
  methods: {
    ...
    splitImagesIntoFourColumns(data) {
      let index = 0;
      for (index = 0; index < data.length - 0; index += 1) {
